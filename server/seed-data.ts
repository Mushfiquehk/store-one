...
function buildSeedData() {
  ...
  const inventoryItems: InventoryItem[] = [
    ...
    { id: `${D}inv_lavender_syrup`, name: "Lavender Syrup", unitOfMeasure: "pumps", currentQuantity: 300, lowStockThreshold: 50, lastPurchasePrice: 900, updatedAt: now, deletedAt: null },
