...
const D = DEMO_PREFIX;
const V = (s: string) => `${D}var_${s}`;
const MG = (s: string) => `${D}mg_${s}`;
const MOD = (s: string) => `${D}mod_${s}`;
const B = (s: string) => `${D}bom_${s}`;
...
function buildSeedData() {
  ...
  const inventoryItems: InventoryItem[] = [
    { id: `${D}inv_espresso_beans`, name: "Espresso Beans", unitOfMeasure: "oz", currentQuantity: 640, lowStockThreshold: 100, lastPurchasePrice: 1200 / 32, purchaseUnit: "2 lb bag", unitsPerPurchase: 32, updatedAt: now, deletedAt: null },
    { id: `${D}inv_whole_milk`, name: "Whole Milk", unitOfMeasure: "oz", currentQuantity: 512, lowStockThreshold: 64, lastPurchasePrice: 450 / 128, purchaseUnit: "gallon", unitsPerPurchase: 128, updatedAt: now, deletedAt: null },
    { id: `${D}inv_oat_milk`, name: "Oat Milk", unitOfMeasure: "oz", currentQuantity: 384, lowStockThreshold: 48, lastPurchasePrice: 650 / 64, purchaseUnit: "64 oz carton", unitsPerPurchase: 64, updatedAt: now, deletedAt: null },
    { id: `${D}inv_almond_milk`, name: "Almond Milk", unitOfMeasure: "oz", currentQuantity: 256, lowStockThreshold: 48, lastPurchasePrice: 550 / 64, purchaseUnit: "64 oz carton", unitsPerPurchase: 64, updatedAt: now, deletedAt: null },
    { id: `${D}inv_skim_milk`, name: "Skim Milk", unitOfMeasure: "oz", currentQuantity: 256, lowStockThreshold: 48, lastPurchasePrice: 400 / 128, purchaseUnit: "gallon", unitsPerPurchase: 128, updatedAt: now, deletedAt: null },
    { id: `${D}inv_vanilla_syrup`, name: "Vanilla Syrup", unitOfMeasure: "pumps", currentQuantity: 500, lowStockThreshold: 50, lastPurchasePrice: 800 / 100, purchaseUnit: "bottle", unitsPerPurchase: 100, updatedAt: now, deletedAt: null },
    { id: `${D}inv_caramel_syrup`, name: "Caramel Syrup", unitOfMeasure: "pumps", currentQuantity: 400, lowStockThreshold: 50, lastPurchasePrice: 850 / 100, purchaseUnit: "bottle", unitsPerPurchase: 100, updatedAt: now, deletedAt: null },
    { id: `${D}inv_hazelnut_syrup`, name: "Hazelnut Syrup", unitOfMeasure: "pumps", currentQuantity: 300, lowStockThreshold: 50, lastPurchasePrice: 900 / 100, purchaseUnit: "bottle", unitsPerPurchase: 100, updatedAt: now, deletedAt: null },
    { id: `${D}inv_lavender_syrup`, name: "Lavender Syrup", unitOfMeasure: "pumps", currentQuantity: 300, lowStockThreshold: 50, lastPurchasePrice: 900 / 100, purchaseUnit: "bottle", unitsPerPurchase: 100, updatedAt: now, deletedAt: null },
    { id: `${D}inv_mocha_sauce`, name: "Mocha Sauce", unitOfMeasure: "pumps", currentQuantity: 300, lowStockThreshold: 30, lastPurchasePrice: 950 / 100, purchaseUnit: "bottle", unitsPerPurchase: 100, updatedAt: now, deletedAt: null },
    { id: `${D}inv_matcha_powder`, name: "Matcha Powder", unitOfMeasure: "tsp", currentQuantity: 200, lowStockThreshold: 20, lastPurchasePrice: 2500 / 50, purchaseUnit: "100 g tin", unitsPerPurchase: 50, updatedAt: now, deletedAt: null },
    { id: `${D}inv_chai_concentrate`, name: "Chai Concentrate", unitOfMeasure: "oz", currentQuantity: 256, lowStockThreshold: 32, lastPurchasePrice: 1100 / 32, purchaseUnit: "32 oz carton", unitsPerPurchase: 32, updatedAt: now, deletedAt: null },
    { id: `${D}inv_hot_choc_mix`, name: "Hot Chocolate Mix", unitOfMeasure: "oz", currentQuantity: 200, lowStockThreshold: 24, lastPurchasePrice: 700 / 32, purchaseUnit: "2 lb tub", unitsPerPurchase: 32, updatedAt: now, deletedAt: null },
    { id: `${D}inv_whipped_cream`, name: "Whipped Cream", unitOfMeasure: "oz", currentQuantity: 300, lowStockThreshold: 30, lastPurchasePrice: 500 / 14, purchaseUnit: "14 oz can", unitsPerPurchase: 14, updatedAt: now, deletedAt: null },
    { id: `${D}inv_ice`, name: "Ice", unitOfMeasure: "oz", currentQuantity: 2000, lowStockThreshold: 200, lastPurchasePrice: null, purchaseUnit: null, unitsPerPurchase: 1, updatedAt: now, deletedAt: null },
    { id: `${D}inv_flour`, name: "All-Purpose Flour", unitOfMeasure: "oz", currentQuantity: 800, lowStockThreshold: 100, lastPurchasePrice: 300 / 80, purchaseUnit: "5 lb bag", unitsPerPurchase: 80, updatedAt: now, deletedAt: null },
    { id: `${D}inv_butter`, name: "Butter", unitOfMeasure: "oz", currentQuantity: 400, lowStockThreshold: 50, lastPurchasePrice: 600 / 16, purchaseUnit: "pound", unitsPerPurchase: 16, updatedAt: now, deletedAt: null },
    { id: `${D}inv_sugar`, name: "Sugar", unitOfMeasure: "oz", currentQuantity: 600, lowStockThreshold: 60, lastPurchasePrice: 250 / 64, purchaseUnit: "4 lb bag", unitsPerPurchase: 64, updatedAt: now, deletedAt: null },
    { id: `${D}inv_blueberries`, name: "Blueberries", unitOfMeasure: "oz", currentQuantity: 100, lowStockThreshold: 12, lastPurchasePrice: 400 / 12, purchaseUnit: "pint", unitsPerPurchase: 12, updatedAt: now, deletedAt: null },
    { id: `${D}inv_choc_chips`, name: "Chocolate Chips", unitOfMeasure: "oz", currentQuantity: 150, lowStockThreshold: 16, lastPurchasePrice: 350 / 12, purchaseUnit: "12 oz bag", unitsPerPurchase: 12, updatedAt: now, deletedAt: null },
    { id: `${D}inv_cream_cheese`, name: "Cream Cheese", unitOfMeasure: "oz", currentQuantity: 200, lowStockThreshold: 20, lastPurchasePrice: 450 / 8, purchaseUnit: "8 oz block", unitsPerPurchase: 8, updatedAt: now, deletedAt: null },
    { id: `${D}inv_croissant_dough`, name: "Croissant Dough", unitOfMeasure: "each", currentQuantity: 48, lowStockThreshold: 6, lastPurchasePrice: 3600 / 24, purchaseUnit: "case of 24", unitsPerPurchase: 24, updatedAt: now, deletedAt: null },
    { id: `${D}inv_bagel_dough`, name: "Bagel Dough", unitOfMeasure: "each", currentQuantity: 60, lowStockThreshold: 8, lastPurchasePrice: 3600 / 36, purchaseUnit: "case of 36", unitsPerPurchase: 36, updatedAt: now, deletedAt: null },
    { id: `${D}inv_sourdough`, name: "Sourdough Bread", unitOfMeasure: "slices", currentQuantity: 80, lowStockThreshold: 10, lastPurchasePrice: 500 / 20, purchaseUnit: "loaf", unitsPerPurchase: 20, updatedAt: now, deletedAt: null },
    { id: `${D}inv_white_bread`, name: "White Bread", unitOfMeasure: "slices", currentQuantity: 100, lowStockThreshold: 12, lastPurchasePrice: 380 / 22, purchaseUnit: "loaf", unitsPerPurchase: 22, updatedAt: now, deletedAt: null },
    { id: `${D}inv_wheat_bread`, name: "Wheat Bread", unitOfMeasure: "slices", currentQuantity: 90, lowStockThreshold: 12, lastPurchasePrice: 420 / 22, purchaseUnit: "loaf", unitsPerPurchase: 22, updatedAt: now, deletedAt: null },
    { id: `${D}inv_turkey`, name: "Turkey Breast", unitOfMeasure: "oz", currentQuantity: 160, lowStockThreshold: 20, lastPurchasePrice: 800 / 16, purchaseUnit: "pound", unitsPerPurchase: 16, updatedAt: now, deletedAt: null },
    { id: `${D}inv_ham`, name: "Ham", unitOfMeasure: "oz", currentQuantity: 120, lowStockThreshold: 16, lastPurchasePrice: 700 / 16, purchaseUnit: "pound", unitsPerPurchase: 16, updatedAt: now, deletedAt: null },
    { id: `${D}inv_cheddar`, name: "Cheddar Cheese", unitOfMeasure: "slices", currentQuantity: 100, lowStockThreshold: 12, lastPurchasePrice: 600 / 24, purchaseUnit: "pack of 24 slices", unitsPerPurchase: 24, updatedAt: now, deletedAt: null },
    { id: `${D}inv_swiss`, name: "Swiss Cheese", unitOfMeasure: "slices", currentQuantity: 80, lowStockThreshold: 10, lastPurchasePrice: 700 / 24, purchaseUnit: "pack of 24 slices", unitsPerPurchase: 24, updatedAt: now, deletedAt: null },
    { id: `${D}inv_lettuce`, name: "Lettuce", unitOfMeasure: "leaves", currentQuantity: 200, lowStockThreshold: 20, lastPurchasePrice: 200 / 40, purchaseUnit: "head", unitsPerPurchase: 40, updatedAt: now, deletedAt: null },
    { id: `${D}inv_tomato`, name: "Tomato", unitOfMeasure: "slices", currentQuantity: 150, lowStockThreshold: 15, lastPurchasePrice: 80 / 8, purchaseUnit: "each", unitsPerPurchase: 8, updatedAt: now, deletedAt: null },
    { id: `${D}inv_avocado`, name: "Avocado", unitOfMeasure: "oz", currentQuantity: 100, lowStockThreshold: 12, lastPurchasePrice: 200 / 6, purchaseUnit: "each", unitsPerPurchase: 6, updatedAt: now, deletedAt: null },
    { id: `${D}inv_bottled_water`, name: "Bottled Water", unitOfMeasure: "each", currentQuantity: 72, lowStockThreshold: 12, lastPurchasePrice: 1200 / 24, purchaseUnit: "case of 24", unitsPerPurchase: 24, updatedAt: now, deletedAt: null },
    { id: `${D}inv_beans_12oz`, name: "Retail Beans 12oz Bag", unitOfMeasure: "each", currentQuantity: 30, lowStockThreshold: 5, lastPurchasePrice: 9600 / 12, purchaseUnit: "case of 12", unitsPerPurchase: 12, updatedAt: now, deletedAt: null },
    { id: `${D}inv_beans_1lb`, name: "Retail Beans 1lb Bag", unitOfMeasure: "each", currentQuantity: 20, lowStockThreshold: 3, lastPurchasePrice: 12000 / 12, purchaseUnit: "case of 12", unitsPerPurchase: 12, updatedAt: now, deletedAt: null },
    { id: `${D}inv_travel_mug`, name: "Travel Mugs", unitOfMeasure: "each", currentQuantity: 15, lowStockThreshold: 3, lastPurchasePrice: 6000 / 12, purchaseUnit: "case of 12", unitsPerPurchase: 12, updatedAt: now, deletedAt: null },
  ];
  ...
  const modifiers: Modifier[] = [
    ...
    { id: MOD("lavender"), modifierGroupId: MG("syrup"), name: "Lavender", baseUpcharge: 65, inventoryItemId: `${D}inv_lavender_syrup`, quantityPerUse: 2, updatedAt: now, deletedAt: null },
  ...
  const productModifierGroups: ProductModifierGroup[] = [
    ...
    { productId: `${D}prod_cappuccino`, modifierGroupId: MG("syrup"), scaleFactors: null, updatedAt: now, deletedAt: null },
    { productId: `${D}prod_cappuccino`, modifierGroupId: MG("extras"), scaleFactors: null, updatedAt: now, deletedAt: null },
    { productId: `${D}prod_americano`, modifierGroupId: MG("syrup"), scaleFactors: null, updatedAt: now, deletedAt: null },
    ...
    { productId: `${D}prod_mocha`, modifierGroupId: MG("syrup"), scaleFactors: null, updatedAt: now, deletedAt: null },
  ...
  return { products, variants, inventoryItems, modifierGroups, productModifierGroups, modifiers, bomEntries, employees };
}
...
const orderPool: OrderTemplate[] = [
  ...
  { productId: `${D}prod_mocha`, variantId: V("mocha_m"), productName: "Mocha", variantName: "Medium", basePrice: 575, mods: [{ modifierId: MOD("whole_milk"), name: "Whole Milk", unitPrice: 0 }], weight: 7 },
  { productId: `${D}prod_matcha_latte`, variantId: V("matcha_m"), productName: "Matcha Latte", variantName: "Medium", basePrice: 550, mods: [{ modifierId: MOD("oat_milk"), name: "Oat Milk", unitPrice: 75 }], weight: 5 },
  { productId: `${D}prod_chai_latte`, variantId: V("chai_m"), productName: "Chai Latte", variantName: "Medium", basePrice: 500, mods: [{ modifierId: MOD("whole_milk"), name: "Whole Milk", unitPrice: 0 }], weight: 6 },
  { productId: `${D}prod_hot_choc`, variantId: V("hc_m"), productName: "Hot Chocolate", variantName: "Medium", basePrice: 450, mods: [{ modifierId: MOD("whole_milk"), name: "Whole Milk", unitPrice: 0 }, { modifierId: MOD("whip"), name: "Whipped Cream", unitPrice: 50 }], weight: 5 },
  ...
  { productId: `${D}prod_cold_brew`, variantId: V("cb_m"), productName: "Cold Brew", variantName: "Medium", basePrice: 475, weight: 9 },
...
function generateSales(): Sale[] {
  ...
  for (let d = 14; d >= 0; d--) {
    ...
    const orderCount = isWeekend ? 25 + Math.floor(random() * 15) : 18 + Math.floor(random() * 12);
    ...
    for (let o = 0; o < orderCount; o++) {
      ...
      for (let i = 0; i < itemCount; i++) {
        const tmpl = pickItem();
        const modEntries = (tmpl.mods || []).map(m => ({ modifierId: m.modifierId, name: m.name, qty: 1, unitPrice: m.unitPrice }));
...
export function getDemoSeedRecords(): SeedRecord[] {
  ...
  const push = (tableName: string, items: Array<{ id?: string; updatedAt: number; deletedAt: number | null } & Record<string, unknown>>, idFn?: (item: Record<string, unknown>) => string) => {
    for (const item of items) {
      const recordId = idFn ? idFn(item) : (item.id as string);
      records.push({ tableName, recordId, data: item as unknown as Record<string, unknown>, updatedAt: item.updatedAt, deletedAt: item.deletedAt });
    }
  };

  push("products", data.products);
  push("variants", data.variants);
  push("inventoryItems", data.inventoryItems);
  push("modifierGroups", data.modifierGroups);
  push("productModifierGroups", data.productModifierGroups as unknown as Array<{ id?: string; updatedAt: number; deletedAt: number | null }>,
    (item) => `${(item as unknown as ProductModifierGroup).productId}::${(item as unknown as ProductModifierGroup).modifierGroupId}`);
  push("modifiers", data.modifiers);
  push("billOfMaterials", data.bomEntries);
  push("sales", sales);
